...
def successful_star(count):
    font = pygame.font.SysFont(None, 25)
    text = font.render("Star: "+str(count), True, BLACK)
    gameDisplay.blit(text,(0,0))

# function for life point (hearts)
def successful_heart(countheart):
    font = pygame.font.SysFont(None, 25)
    text = font.render("Star: "+str(countheart), True, RED)
...
def game_intro():
    ...
    while intro: # intro loop
        ...
        # display background
        gameDisplay.blit(intro_background,intro_pic)
        # display horse
        gameDisplay.blit(horse_img,horse)
        # display Go button
        pygame.draw.rect(gameDisplay,GREEN,[100, 10, 100, 60])
        # display Quit button
        pygame.draw.rect(gameDisplay,RED,[400, 10, 100, 60])
        # display text
        largeText = pygame.font.SysFont("comicsansms", 90)
        smallText = pygame.font.SysFont("comicsansms", 20)
        # text
        draw_text("Horse Course", largeText, gameDisplay, (W/2),300)
        draw_text("GO", smallText, gameDisplay, (100+100/2),(10+50/2))
        draw_text("QUIT", smallText, gameDisplay, (400+100/2),(10+50/2))
